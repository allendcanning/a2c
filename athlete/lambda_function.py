...
def edit_athlete_info(config,environment,record):
  ...
  user_record += '<input type="hidden" name="key" value="'+key.encode('UTF-8')+'" />\n'
  user_record += '<input type="hidden" name="acl" value="'+acl.encode('UTF-8')+'" />\n'
  user_record += '<input type="hidden" name="x-amz-server-side-encryption" value="'+amz_server_side_encryption.encode('UTF-8')+'" />\n'
  user_record += '<input type="hidden" name="x-amz-credential" value="'+amz_credential.encode('UTF-8')+'" />\n'
  user_record += '<input type="hidden" name="x-amz-algorithm" value="'+amz_algorithm.encode('UTF-8')+'" />\n'
  user_record += '<input type="hidden" name="x-amz-date" value="'+amz_date.encode('UTF-8')+'" />\n'
  user_record += '<input type="hidden" name="policy" value="'+string_to_sign.encode('UTF-8')+'" />\n'
  user_record += '<input type="hidden" name="x-amz-signature" value="'+signature.encode('UTF-8')+'" />\n'
